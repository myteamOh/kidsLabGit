			...
			<form>
				...
				<table>
					...
					<tr>
						...
						<td><input type="password" maxlength="13"><label>확인 라벨</label></td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" value="${parent.parent_phone}" maxlength="11">
					...
					<tr>
						...
						<td><c:choose>
							...
							</c:choose><label for="parent_smsagree">SMS 수신 동의(선택)</label> <br>
				...
				<div>
					<input type="button" id="okBtn" value="수정 완료"> <input type="button" id="cancelBtn"
						value="취소"> <input type="button" id="secessionBtn" value="탈퇴">
				</div>
