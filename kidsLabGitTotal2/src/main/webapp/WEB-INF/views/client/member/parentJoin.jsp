			...
			<table id="joinForm">
				...
				<tr>
					...
					<td><input type="radio" id="search" name="parent_knowroute"
						...
						name="parent_knowroute" value="banner"><label for="banner">현수막</label>
						<input type="radio" id="leaflet" name="parent_knowroute"
						value="leaflet"><label for="leaflet">전단지</label> <input
						type="radio" id="etcetera" name="parent_knowroute"
						value="etcetera"><label for="etcetera">기타</label></td>
				</tr>
