...
<script type="text/javascript">
	...
	function chgTime() {
		...
		if (uform.course_day.value == "monday" || uform.course_day.value == "thusday" || uform.course_day.value == "thursday" || uform.course_day.value == "friday") {
			uform.course_hour.length = 3;
			uform.course_hour.options[0].text = "15:00 ~ 16:45";
			uform.course_hour.options[0].value = "first";
			uform.course_hour.options[1].text = "17:00 ~ 18:45";
			uform.course_hour.options[1].value = "second";
			uform.course_hour.options[2].text = "19:00 ~ 20:45";
			uform.course_hour.options[2].value = "third";
		} else {
			...
			uform.course_hour.options[3].value = "third";
		}
	}
				...
				<div class="form-group form-group-sm">
					...
					<div class="col-sm-3">
						<select id="course_day" name="course_day" onchange="chgTime()">
							...
							<option value="thusday">화요일</option>
							<option value="thursday">목요일</option>
							<option value="friday">금요일</option>
							<option value="saturday">토요일</option>
						</select> <select id="course_hour" name="course_hour">
							<option value="first">15:00 ~ 16:45</option>
							<option value="second">17:00 ~ 18:45</option>
							<option value="third">19:00 ~ 20:45</option>
						</select>
					</div>
					<div class="col-sm-5">
						<p class="form-control-static error"></p>
