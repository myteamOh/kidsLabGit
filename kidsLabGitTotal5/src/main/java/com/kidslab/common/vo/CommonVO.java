...
public class CommonVO extends LoginHistory {
	...
	public CommonVO(String page, String pageSize, String start_row, String end_row, String search, String keyword,
			String status, String order_by, String order_sc, String result_cd, String result_msg, String start_date,
			String end_date) {
		super();
		this.page = page;
